...
VOID bodx::render::Start( INT cnt )
{
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // Clear render target and setup borders cut
  ////////////////////////////////////////////////////////////////////////////////////
  D3D12_CPU_DESCRIPTOR_HANDLE CDHDB {};

  CDHDB = DSVHeap->GetCPUDescriptorHandleForHeapStart();

  D3D12_RECT DBRect = {0, 0, Width, Height};
  ComList->ClearDepthStencilView(CDHDB, D3D12_CLEAR_FLAG_DEPTH, 1.0f, 0, 1, &DBRect);
  ...
  // Record commands.
  ComList->ClearRenderTargetView(RTVHandle, BackColor, FALSE, nullptr);
